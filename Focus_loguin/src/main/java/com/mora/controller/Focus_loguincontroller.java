...
public class Focus_loguincontroller {
	...
	@Value("${login.usuario3:javadoubts}")
	private String loginUsuario3;
	
	@Value("${login.clave3:javadoubts}")
	private String loginClave3;
	...
	public String getValue(@RequestBody Leeapi pos) {
		...
		else if (usuario.equals(loginUsuario3) && clave.equals(loginClave3)) {
			System.out.println ("Usuario3: " + loginUsuario3);
			System.out.println ("Clave3:   " + loginClave3);
			return siva;
		} 
		else { return nova; }
